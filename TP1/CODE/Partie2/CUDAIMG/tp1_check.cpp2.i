# 1 "CUDAIMG/tp1_check.cudafe1.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 180 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/crt/device_runtime.h" 3
...
extern __attribute__((device)) void __assertfail(
  ...
  const void *function,
  size_t charsize);
# 233 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/crt/device_runtime.h" 3
...
# 126 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/cuda_device_runtime_api.h"
extern __attribute__((device)) enum cudaError cudaFree(void *);
# 127 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/cuda_device_runtime_api.h"
extern __attribute__((device)) enum cudaError cudaMalloc(void **, size_t);
# 119 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/common_functions.h"
 __attribute__((device_builtin)) extern __attribute__((device)) int printf(const char *__restrict__, ...);
# 124 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/common_functions.h"
extern __attribute__((device)) __attribute__((__malloc__)) __attribute__((__nothrow__)) void *malloc(size_t);
# 125 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/common_functions.h"
extern __attribute__((device)) __attribute__((__nothrow__)) void free(void *);
# 206 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/math_functions.h"
 __attribute__((device_builtin)) extern __attribute__((device)) __attribute__((__nothrow__)) __attribute__((__const__)) double fabs(double);
# 5 "tp1_check.cu"
__attribute__((global)) extern void _Z6kernelPdS_S_i(double *, double *, double *, int);
# 1 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/common_functions.h" 1
# 224 "/usr/local/cuda-7.5/bin/../targets/x86_64-linux/include/common_functions.h"
...
# 7 "tp1_check.cu" 2
# 5 "tp1_check.cu"
__attribute__((global)) void _Z6kernelPdS_S_i(
# 5 "tp1_check.cu"
double *a,
# 5 "tp1_check.cu"
double *b,
